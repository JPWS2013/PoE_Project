/*
This script runs code that allows dominobot to receive drive decisions from a raspberry pi and implement to physically control DC motors that drive the robot and dispense dominos.

This script was written as part of Principles of Engineering, Fall 2013 at Olin College of Engineering
*/
